import 'package:bloc_learning_eng_usama_course/bloc_learning/bloc/counter_bloc.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';

class CounterAppScreenWithBloc extends StatelessWidget {
  const CounterAppScreenWithBloc({super.key});
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        onPressed: () {
                          context.read<CounterBloc>().add(decre());
                        },
                      ...
                      ElevatedButton(
                        onPressed: () {
                          context.read<CounterBloc>().add(incre());
                        },
                        child: Text('+', style: TextStyle(fontSize: 30)),
                      ),
                    ],
